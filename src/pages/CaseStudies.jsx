    ...
    <main id="casestudy" className="relative">
        ...
        <section className="py-20 relative">
          ...
          <div className="flex flex-wrap justify-center lg:flex-nowrap lg:justify-between gap-5 px-30 lg:px-40 mt-12">
            <div className="bg-white rounded-lg p-5 md:w-[45%] lg:w-2/6 space-y-3 text-center">
              <img src="/src/assets/pic1.png" alt="pic1" width="250" height="180" className="mx-auto rounded-md" />
            ...
            <div className="bg-white rounded-lg p-5 md:w-[45%] lg:w-2/6 space-y-3 text-center">
              <img src="/src/assets/pic2.png" alt="pic2" width="250" height="180" className="mx-auto rounded-md" />
            ...
            <div className="bg-white rounded-lg p-5 md:w-[45%] lg:w-2/6 space-y-3 text-center">
              <img src="/src/assets/pic3.png" alt="pic3" width="250" height="180" className="mx-auto rounded-md" />
      ...
      <section className="bg-white py-20">
        ...
        <div className='grid grid-cols-2 lg:grid-cols-5 gap-4 px-10 md:px-14 lg:px-20 py-4'>
            <img src="/src/assets/img1.png" alt="img1" className='h-24 w-full' />
            <img src="/src/assets/img2.png" alt="img2" className='h-24 w-full' />
            <img src="/src/assets/img3.png" alt="img3" className='h-24 w-full' />
            <img src="/src/assets/img4.png" alt="img4" className='h-24 w-full' />
            <img src="/src/assets/img5.png" alt="img5" className='h-24 w-full' />
        </div>
      </section>
    </main>
  );
